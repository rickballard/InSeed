...
- **GIBindex**: will eventually hold indexed entries for Moonshot-related concepts (guardrail frameworks, transparency patterns, CoPortal/CoGibber interfaces).
- **CoPortal / CoGibber / GBX**: Moonshot's JSON section map is designed to be a natural candidate for AI-facing portal integration.
